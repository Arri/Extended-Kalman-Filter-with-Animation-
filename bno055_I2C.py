###################################################
# I2C communication with the BNO055
# Author: Arasch Lagies
# First Version: 6/24/2020
# Last Update:
#
###################################################
import smbus
...
class BNO055:
    ...
    def backgroundThread(self):    # retrieve data
        ...
        while (self.isRun):
            self.rawData[0], self.rawData[1], self.rawData[2] = self.getVector(self.VECTOR_GYROSCOPE)
            self.rawData[3], self.rawData[4], self.rawData[5] = self.getVector(self.VECTOR_ACCELEROMETER)
            self.rawData[6], self.rawData[7], self.rawData[8] = self.getVector(self.VECTOR_MAGNETOMETER)
...
if __name__ == '__main__':
    ...
    while True:
        print(f"Accelerometer (x,y,z) = {bno.getVector(BNO055.VECTOR_ACCELEROMETER)}, Magnetometer (x,y,z) = {bno.getVector(BNO055.VECTOR_MAGNETOMETER)}.")    #BNO055.VECTOR_EULER))
        time.sleep(0.01)
